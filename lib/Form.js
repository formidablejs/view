...
class Form {
	[$__patch__$]($$ = {}){
		...
		($3 = $$.initialForm) !== undefined && (this.initialForm = $3);
	...
	[$__init__$]($$ = null,deep = true){
		...
		this.initialForm = $$ ? $$.initialForm : undefined;
	...
	*/
	reset(){
		...
		this.form = $1.trim(this.initialForm || {});
	...
	*/
	fill(){
		...
		Object.keys(self.form).forEach(function(key) {
			...
			if (!self.formWasFilled) { return self[key] = self.form[key] };
		});
